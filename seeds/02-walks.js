  ...
  return knex("walks").insert([
    {
      ...
      description:
        "Goldies Bush and Mokoroa Falls Loop is a 6.0 kilometer lightly trafficked loop trail located near Auckland, Auckland, New Zealand that features a waterfall and is rated as moderate. The trail is primarily used for hiking, walking, and nature trips."
    },
    {
      id: 2,
      ...
      mainPhoto:
        "https://www.freewalks.nz/sites/www.freewalks.nz/files/styles/full__desktop/public/images/tracks/western_spring_1.jpg?itok=T8GWhSxC",
      photos: JSON.stringify([
      ...
      description:
        "Western Springs Park Walk is a very easy 1.8k walk that will take you around 30 mins to complete. Highlights of the Western Springs Park Walk are the eels and the free tram ride around Western Spring Park. It surrounds a natural spring-fed lake, one of Auckland's early water supplies."
    },
    {
      id: 3,
      ...
      description:
        "Te Henga Walkway is a 10.0 kilometer lightly trafficked point-to-point trail located near Henderson, Auckland, New Zealand that offers the chance to see wildlife and is rated as moderate. The trail is primarily used for hiking, walking, and nature trips and is accessible year-round."
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description:
        "Easy 2 hour round trip walk to One Tree Hill in Auckland. Excellent 360 views over Auckland from the top of One Tree Hill. Unfortunately the 'one tree' is now no longer and is only a stump. No car access to the top of One Tree Hill anymore."
    },
    {
      id: 8,
      ...
      location: "Auckland",
      mainPhoto:
        "https://cdn-assets.alltrails.com/uploads/photo/image/22828781/extra_large_28431b706fa28a1162c958488bf2eccb.jpg",
      photos: JSON.stringify([
      ...
      description:
        "Kitekite Falls Hike is a 3.5 kilometer moderately trafficked out and back trail located near Auckland, Auckland, New Zealand that features a waterfall and is good for all skill levels. The trail is primarily used for hiking, walking, and nature trips and is accessible year-round."
    },
    {
      id: 9,
      ...
      location: "Orakei",
      mainPhoto:
        "https://cdn-assets.alltrails.com/uploads/photo/image/20660748/extra_large_66be6172df679b4a88f6f4f8f993268c.jpg",
      photos: JSON.stringify([
      ...
      Surface: "wooden path",
      description:
        "Orakei Basin Walkway is a 3.1 kilometer moderately trafficked loop trail located near Auckland, Auckland, New Zealand that features a lake and is good for all skill levels. The trail is primarily used for walking, running, nature trips, and bird watching and is accessible year-round."
    },
    {
      id: 10,
      ...
      location: "Long Bay",
      mainPhoto:
        "https://www.freewalks.nz/sites/www.freewalks.nz/files/styles/full__desktop/public/images/tracks/nature_walk_at_long_bay_regional_park_in_auckland_2.jpg?itok=r_mqx9HZ",
      photos: JSON.stringify([
